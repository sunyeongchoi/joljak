...
<br /><br /><br />
  ...
  <table class="body" >
    ...
    <tr bgcolor="f9eefa">
      ...
      <td><strong><%=board_writer%></strong></td>
...
String listSql = "select board_comment_no, board_comment_content, board_comment_writer, board_comment_date, board_number from board_comment join board WHERE board_number=board_no order by board_comment_no desc;";
  ...
  %>
   <p> </p>
    ...
    <input type=image src="images/update.png" id="update" value="수정">

    <input type=image src="images/delete.png" id="delete" value="삭제">
    
    <input type=image src="images/list.png" id="list" value="목록">
